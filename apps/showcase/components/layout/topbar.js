        ...
        <div className="layout-topbar">
            <div className="layout-topbar-inner">
                <div className="layout-topbar-logo-container">
                    <a className="layout-topbar-logo" href="/" aria-label="PrimeReact logo">
                        <svg width="146" height="35" viewBox="0 0 146 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M22.0969 18.6465L20.3461 18.2616L21.7078 20.1862V26.1522L26.0214 22.3031L26.3764 15.7598L24.2367 16.5296L22.0969 18.6465Z" fill="var(--logo-color)" />
                            <path d="M11.2035 18.6465L12.9543 18.2616L11.5926 20.1862V26.1522L7.27906 22.3031L6.92397 15.7598L9.06376 16.5296L11.2035 18.6465Z" fill="var(--logo-color)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M12.1761 20.5713L13.7323 18.2618L14.7049 18.8392H18.5955L19.5681 18.2618L21.1243 20.5713V29.2316L19.3056 32.6659H13.6397L12.1761 29.2316V20.5713Z" fill="var(--logo-color)" />
                            <path d="M21.7079 29.8089L24.2367 27.3071V24.8052L21.7079 26.9221V29.8089Z" fill="var(--logo-color)" />
                            <path d="M11.5927 29.8089L9.06387 27.3071V24.8052L11.5927 26.9221V29.8089Z" fill="var(--logo-color)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M16.2613 7.09967H14.1215L12.5652 10.7563L15.0941 18.0694H18.401L20.7353 10.7563L19.1791 7.09967H17.0394V18.0694H16.2613V7.09967Z" fill="var(--logo-color)" />
                            <path d="M15.0942 18.0694L6.7296 14.9901L5.56244 10.1788L12.7599 10.7562L15.2887 18.0694H15.0942Z" fill="var(--logo-color)" />
                            <path d="M18.4011 18.0694L26.7658 14.9901L27.9329 10.1788L20.5409 10.7562L18.2066 18.0694H18.4011Z" fill="var(--logo-color)" />
                            <path d="M21.1245 10.1789L24.8545 9.794L22.4862 7.09967H19.7628L21.1245 10.1789Z" fill="var(--logo-color)" />
                            <path d="M12.1762 10.1789L8.4462 9.794L10.8145 7.09967H13.5378L12.1762 10.1789Z" fill="var(--logo-color)" />
                        </svg>
                    </a>
                    <a className="layout-topbar-icon" href="/" aria-label="PrimeReact logo">
                        <svg width="32" height="35" viewBox="0 0 32 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M21.8341 18.6465L20.0833 18.2616L21.445 20.1862V26.1522L25.7586 22.3031L26.1137 15.7598L23.9739 16.5296L21.8341 18.6465Z" fill="var(--logo-color)" />
                            <path d="M10.9407 18.6465L12.6914 18.2616L11.3298 20.1862V26.1522L7.01621 22.3031L6.66113 15.7598L8.80091 16.5296L10.9407 18.6465Z" fill="var(--logo-color)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M11.9133 20.5713L13.4695 18.2618L14.4421 18.8392H18.3327L19.3053 18.2618L20.8615 20.5713V29.2316L19.0428 32.6659H13.3769L11.9133 29.2316V20.5713Z" fill="var(--logo-color)" />
                            <path d="M21.4451 29.8089L23.9739 27.3071V24.8052L21.4451 26.9221V29.8089Z" fill="var(--logo-color)" />
                            <path d="M11.3299 29.8089L8.80102 27.3071V24.8052L11.3299 26.9221V29.8089Z" fill="var(--logo-color)" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M15.9985 7.09967H13.8586L12.3024 10.7563L14.8313 18.0694H18.1382L20.4725 10.7563L18.9163 7.09967H16.7766V18.0694H15.9985V7.09967Z" fill="var(--logo-color)" />
                            <path d="M14.8314 18.0694L6.46675 14.9901L5.29959 10.1788L12.4971 10.7562L15.0259 18.0694H14.8314Z" fill="var(--logo-color)" />
                            <path d="M18.1383 18.0694L26.5029 14.9901L27.6701 10.1788L20.2781 10.7562L17.9438 18.0694H18.1383Z" fill="var(--logo-color)" />
                            <path d="M20.8617 10.1789L24.5916 9.794L22.2233 7.09967H19.5L20.8617 10.1789Z" fill="var(--logo-color)" />
                            <path d="M11.9134 10.1789L8.18341 9.794L10.5517 7.09967H13.2751L11.9134 10.1789Z" fill="var(--logo-color)" />
                        </svg>
                    </a>
                </div>
                ...
                <ul className="topbar-items">
                    ...
                    <li>
                        <a href="https://github.com/primefaces/primevue" target="_blank" rel="noopener noreferrer" className="topbar-item">
                            <i className="pi pi-github"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://discord.gg/gzKFYnpmCY" target="_blank" rel="noopener noreferrer" className="topbar-item">
                            <i className="pi pi-discord"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://github.com/orgs/primefaces/discussions" target="_blank" rel="noopener noreferrer" className="topbar-item">
                    ...
                    <li>
                        <button type="button" style={{ maxWidth: '8rem' }} className="topbar-item version-item">
                            <span className="version-text">{versions[0].name}</span>
                            <span className="version-icon pi pi-angle-down"></span>
                        </button>
                    </li>
                    <li v-if="showMenuButton" className="menu-button">
                        <button type="button" className="topbar-item menu-button" aria-haspopup aria-label="Menu">
