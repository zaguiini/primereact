        ...
        inputtext: {
            root: ({ props, context }) => ({
                className: classNames(
                    ...
                    {
                        'text-lg px-6 py-6': props.size == 'large',
                        'text-xs px-2 py-2': props.size == 'small',
                        'p-4 text-base': props.size == null
                    }
                )
            })
        },
        panel: {
            header: ({ props }) => ({
                className: classNames(
                    ...
                    { 'p-8': !props.toggleable, 'py-4 px-8': props.toggleable } // condition
                )
            }),
            ...
            toggler: {
                className: classNames(
                    ...
                    'w-8/12 h-8 text-gray-600 border-surface-0 dark:border-surface-900 bg-transparent rounded-full transition duration-200 ease-in-out', // widths, borders, and transitions
            ...
            content: {
                className: classNames(
                    'p-8 border border-gray-300 bg-white text-gray-700 border-t-0 last:rounded-br-lg last:rounded-bl-lg',
                    'dark:bg-gray-900 dark:border-blue-900/40 dark:text-white/80' // Dark mode
                )
            },
