    ...
    fieldset: {
        root: {
            className: classNames(
                'border border-gray-300 bg-white text-gray-700 rounded-md block mx-2 my-0.5 pl-6 pr-8 inline-size-min', // Borders, background, text color, spacing, and inline size.
        ...
        legend: ({ props }) => ({
            className: classNames(
                ...
                'dark:bg-gray-900 dark:border-blue-900/40 dark:text-white/80 ', //dark
                {
                    ...
                    'p-8': !props.toggleable
                }
            )
        }),
        toggler: ({ props }) => ({
            className: classNames('flex items-center justify-center', {
                'p-8 text-gray-700 rounded-md transition-none cursor-pointer overflow-hidden relative select-none hover:text-gray-900 focus:focus:shadow-[inset_0_0_0_0.2rem_rgba(191,219,254,1)] dark:text-white/80 dark:hover:text-white/80 dark:hover:bg-gray-800/60 dark:focus:shadow-[inset_0_0_0_0.2rem_rgba(147,197,253,0.5)]':
                    props.toggleable
            })
        }),
