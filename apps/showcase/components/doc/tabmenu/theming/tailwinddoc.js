...
const Tailwind = {
     tabmenu: {
        ...
        menu: {
            className: classNames('flex m-0 p-0 list-none flex-nowrap', 'bg-white border-solid border-gray-300 border-b-2', 'outline-0 no-underline text-base list-none')
        },
        menuitem: 'mr-0',
        action: ({ context, parent }) => ({
            className: classNames(
                'cursor-pointer select-none flex items-center relative no-underline overflow-hidden',
                'border-b-2 p-8 font-bold rounded-t-lg ',
