...
export default function InvalidDemo() {
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <MultiSelect invalid value={selectedCities} onChange={(e) => setSelectedCities(e.value)} options={cities} optionLabel="name" placeholder="Select Cities" maxSelectedLabels={3} className="w-full md:w-80" />
            </div>
