...
const Tailwind = {
    treetable: {
        ...
        header: {
            className: classNames(
                'bg-slate-50 text-slate-700 border border-x-0 border-t-0 border-gray-300 p-6 font-bold',
        ...
        column: {
            ...
            rowtoggler: ({ context }) => ({
                className: classNames(
                    ...
                    'w-8/12 h-8 border-surface-0 dark:border-surface-900 rounded mr-0.5',
                    {
            ...
            checkboxwrapper: {
                className: classNames('cursor-pointer inline-flex relative select-none align-bottom', 'w-6/12 h-6 mr-2')
            },
            checkbox: ({ context }) => ({
                className: classNames(
            ...
            checkboxicon: ({ context }) => ({
                className: classNames('w-4/12 h-4 transition-all duration-200 text-base dark:text-gray-900', {
