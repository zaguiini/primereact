...
const Tailwind = {    
    orderlist: {
        root: 'flex',
        controls: 'flex flex-col justify-center p-8',
        moveupbutton: {
            root: ({ context }) => ({
    ...
    const itemTemplate = (item) => {
        return (
            <div className="flex flex-wrap p-2 items-center gap-4">
                ...
                <span className="font-bold text-gray-700 dark:text-white/80 text-surface-900 dark:text-surface-0">\${item.price}</span>
            </div>
        );
    };
