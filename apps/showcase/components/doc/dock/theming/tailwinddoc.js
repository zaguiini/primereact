...
const Tailwind = {
    dock: {
        root: ({ props }) => ({
            className: classNames('absolute z-10 flex justify-center items-center pointer-events-none', {
        ...
        menu: ({ props }) => ({
            className: classNames('m-0 p-0 list-none flex items-center justify-center', 'outline-0', {
