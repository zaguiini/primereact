...
const Tailwind = {
    menu: {
        ...
        menu: {
            className: classNames('m-0 p-0 list-none', 'outline-0')
        },
        content: ({ state }) => ({
        ...
        action: {
            className: classNames('text-gray-700 dark:text-white/80 py-4 px-8 select-none', 'cursor-pointer flex items-center no-underline overflow-hidden relative')
        },
        menuitem: {
        ...
        submenuheader: {
            className: classNames('m-0 p-4 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-900 font-bold rounded-tl-none rounded-tr-none')
        },
