    ...
    let items = [
        ...
        },
        {
            ...
            template: (item, options) => {
                return (
                    <button onClick={(e) => options.onClick(e)} className={classNames(options.className, 'w-full p-link flex items-center p-2 pl-6 text-color hover:bg-surface-200 dark:hover:bg-surface-600 rounded-none')}>
