    ...
    dataview: {
        content: {
            className: classNames(
                'bg-white blue-gray-700 border-surface-0 dark:border-surface-900 p-0',
                'dark:bg-gray-900 dark:text-white/80' // Dark Mode
            )
        },
        grid: 'flex flex-wrap ml-0 mr-0 mt-0 bg-white dark:bg-gray-900',
        header: 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-white/80 border-gray-200 dark:border-blue-900/40 border-t border-b p-6 font-bold'
    },
    dataviewlayoutoptions: {
        listbutton: ({ props }) => ({
            className: classNames(
                ...
                'w-full pt-4 pb-4 rounded-lg rounded-r-none',
        ...
        gridbutton: ({ props }) => ({
            className: classNames(
                'items-center cursor-pointer inline-flex overflow-hidden relative select-none text-center align-bottom justify-center border',
                'transition duration-200',
                'w-full pt-4 pb-4 rounded-lg rounded-l-none',
                props.layout === 'grid grid-cols-12 gap-4' ? 'bg-blue-500 border-blue-500 text-white dark:bg-sky-300 dark:border-sky-300 dark:text-gray-900' : 'bg-white border-gray-300 text-blue-gray-700 dark:bg-gray-900 dark:border-blue-900/40 dark:text-white/80'
            )
        })
    }
}
...
export default function UnstyledDemo() {
    ...
    const listItem = (product) => {
        return (
            ...
            <div className="flex flex-col xl:flex-row xl:items-start p-6 gap-6 bg-white dark:bg-gray-900">
                <img
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center xl:items-start flex-1 gap-6">
                    ...
                    <div className="flex sm:flex-col items-center sm:align-end gap-4 sm:gap-2">
    ...
    const gridItem = (product) => {
        return (
            ...
            <div className="p-6 border rounded-md bg-white dark:bg-gray-900 border-gray-300 dark:border-blue-900/40">
