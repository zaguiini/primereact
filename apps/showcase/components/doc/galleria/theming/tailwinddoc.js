...
const Tailwind = {    
    galleria: {
        ...
        thumbnailcontainer: {
            className: classNames('flex flex-row', 'bg-black/90 p-6')
        },
        previousthumbnailbutton: {
            className: classNames(
                'self-center flex shrink-0 justify-center items-center overflow-hidden relative',
                'm-2 bg-transparent text-white w-8/12 h-8 transition duration-200 ease-in-out rounded-full',
        ...
        indicators: {
            className: classNames('flex items-center justify-center', 'p-6')
        },
        indicator: 'mr-2',
        indicatorbutton: ({ context }) => ({
            className: classNames('w-4/12 h-4 transition duration-200 rounded-full', 'focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]', {
        ...
        closebutton: {
            className: classNames(
                ...
                'text-white bg-transparent w-full h-12 rounded-full transition duration-200 ease-in-out',
                'hover:text-white hover:bg-white/10',
                'focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)]'
            )
        },
        closeicon: 'w-6/12 h-6',
        previousitembutton: {
            className: classNames(
        ...
        caption: {
            className: classNames('absolute bottom-0 left-0 w-full', 'bg-black/50 text-white p-6')
        },
        transition: {
