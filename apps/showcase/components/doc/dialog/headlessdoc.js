...
<Dialog
    ...
    content={({ hide }) => (
        <div className="flex flex-col px-20 py-8 gap-6" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
            <...>
        </div>
    )}
></Dialog>
                ...
                content={({ hide }) => (
                    <div className="flex flex-col px-20 py-8 gap-6" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                        ...
                        <div className="inline-flex flex-col gap-2">
                            ...
                            <InputText id="username" label="Username" className="bg-white/20 border-0 p-4 text-primary-50"></InputText>
                        </div>
                        <div className="inline-flex flex-col gap-2">
                            <label htmlFor="username" className="text-primary-50 font-semibold">
                                Username
                            </label>
                            <InputText id="password" label="Password" className="bg-white/20 border-0 p-4 text-primary-50" type="password"></InputText>
                        </div>
                        <div className="flex items-center gap-2">
                            <Button label="Sign-In" onClick={(e) => hide(e)} text className="p-4 w-full text-primary-50 border border-white/30 hover:bg-white/10"></Button>
                            <Button label="Cancel" onClick={(e) => hide(e)} text className="p-4 w-full text-primary-50 border border-white/30 hover:bg-white/10"></Button>
                        </div>
                    </div>
                )}
            ></Dialog>
                    ...
                    content={({ hide }) => (
                        <div className="flex flex-col px-20 py-8 gap-6" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                            ...
                            <div className="inline-flex flex-col gap-2">
                                ...
                                <InputText id="username" label="Username" className="bg-white/20 border-0 p-4 text-primary-50" />
                            </div>
                            <div className="inline-flex flex-col gap-2">
                                <label htmlFor="username" className="text-primary-50 font-semibold">
                                    Username
                                </label>
                                <InputText id="password" label="Password" className="bg-white/20 border-0 p-4 text-primary-50" type="password" />
                            </div>
                            <div className="flex items-center gap-2">
                                <Button label="Sign-In" onClick={(e) => hide(e)} text className="p-4 w-full text-primary-50 border border-white/30 hover:bg-white/10" />
                                <Button label="Cancel" onClick={(e) => hide(e)} text className="p-4 w-full text-primary-50 border border-white/30 hover:bg-white/10" />
                            </div>
                        </div>
                    )}
                />
