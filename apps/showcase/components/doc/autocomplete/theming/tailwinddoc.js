...
const Tailwind = {           
    autocomplete: {
        ...
        input: ({ props }) => ({
            root: {
                className: classNames(
                    ...
                    {
                        'font-sans text-base text-gray-700 dark:text-white/80 bg-white dark:bg-gray-900 p-4 border border-gray-300 dark:border-blue-900/40 focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)] hover:border-blue-500 focus:outline-none':
                            !props.multiple,
                        'font-sans text-base text-gray-700 dark:text-white/80 border-surface-0 dark:border-surface-900 outline-0 bg-transparent m-0 p-0 shadow-none rounded-none w-full': props.multiple
                    }
                )
            }
        }),
        ...
        panel: {
            className: classNames('bg-white text-gray-700 border-surface-0 dark:border-surface-900 rounded-md shadow-lg', 'max-h-[200px] overflow-auto', 'dark:bg-gray-900 dark:text-white/80')
        },
