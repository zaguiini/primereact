...
const Tailwind = {
    megamenu: {
        ...
        menu: {
            className: classNames('m-0 sm:p-0 list-none relative', 'outline-0', 'flex items-center flex-wrap flex-row top-auto left-auto relative bg-transparent shadow-none w-auto')
        },
        ...
        panel: ({ props }) => ({
            className: classNames('py-1 bg-white dark:bg-gray-900 border-surface-0 dark:border-surface-900 shadow-md w-auto', 'absolute z-10', {
        ...
        submenuheader: {
            className: classNames('m-0 py-4 px-8 text-gray-700 dark:text-white/80 bg-white dark:bg-gray-900 font-semibold rounded-tr-md rounded-tl-md')
        }
    }
}
        `
