...
export function CustomDoc(props) {
    ...
    const centerContent = (
        <div className="flex flex-wrap items-center gap-4">
            <button className="p-link inline-flex justify-center items-center text-white h-12 w-12 rounded-full hover:bg-white/10 transition-all duration-200">
    ...
    const endContent = (
        <React.Fragment>
            <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-slate-50">Amy Elsner</span>
            </div>
        </React.Fragment>
    );
...
export default function CustomDemo() {
    ...
    return (
        <div className="card">
            <Toolbar start={startContent} center={centerContent} end={endContent} className="bg-gray-900 shadow" style={{ borderRadius: '3rem', backgroundImage: 'linear-gradient(to right, var(--bluegray-500), var(--bluegray-800))' }} />
        </div>
    );
}
        `,
