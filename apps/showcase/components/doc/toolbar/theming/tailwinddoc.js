...
const Tailwind = {
    toolbar: {
        root: {
            className: classNames('flex items-center justify-between flex-wrap', 'bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-blue-900/40  p-8 rounded-md gap-2')
        },
