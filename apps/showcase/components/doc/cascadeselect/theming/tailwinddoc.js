...
const Tailwind = {        
    cascadeselect: {
        ...
        label: {
            className: classNames('block whitespace-nowrap overflow-hidden flex flex-1 w-1/12 text-ellipsis cursor-pointer', 'bg-transparent border-surface-0 dark:border-surface-900 p-4 text-gray-700 dark:text-white/80', 'appearance-none rounded-md')
        },
        dropdownButton: {
        ...
        panel: { className: 'absolute py-4 bg-white dark:bg-gray-900 border-surface-0 dark:border-surface-900 shadow-md' },
        list: { className: 'm-0 sm:p-0 list-none' },
        sublist: {
            className: classNames('block absolute left-full top-0', 'min-w-full z-10', 'py-4 bg-white dark:bg-gray-900 border-surface-0 dark:border-surface-900 shadow-md')
        },
        item: ({ state }) => ({
            className: classNames('cursor-pointer font-normal whitespace-nowrap', 'm-0 border-surface-0 dark:border-surface-900 bg-transparent transition-shadow rounded-none', {
        ...
        content: {
            className: classNames('flex items-center overflow-hidden relative', 'py-4 px-8')
        },
