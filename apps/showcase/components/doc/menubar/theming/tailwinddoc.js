    ...
    menubar: {
        ...
        menu: ({ state }) => ({
            className: classNames(
                ...
                'absolute py-1 bg-white dark:bg-gray-900 border-surface-0 dark:border-surface-900 shadow-md w-full',
                {
        ...
        action: ({ context }) => ({
            className: classNames('select-none', 'cursor-pointer flex items-center no-underline overflow-hidden relative', 'py-4 px-8 select-none', {
                'pl-9 sm:pl-8': context.level === 1,
                'pl-14 sm:pl-8': context.level === 2
            })
        }),
        icon: 'mr-2',
        submenuicon: ({ props }) => ({
        ...
        submenu: ({ props }) => ({
            className: classNames('py-1 bg-white dark:bg-gray-900 border-surface-0 dark:border-surface-900  sm:shadow-md sm:w-48', 'w-full static shadow-none', 'sm:absolute z-10', 'm-0 list-none', {
        ...
        button: {
            className: classNames(
                'flex sm:hidden w-8/12 h-8 rounded-full text-gray-600 dark:text-white/80 transition duration-200 ease-in-out',
