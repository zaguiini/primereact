...
export function DelayDoc(props) {
    ...
    const code = {
        basic: `
<VirtualScroller items={items} itemSize={50} itemTemplate={itemTemplate} className="border border-surface rounded-border" style={{ width: '200px', height: '200px' }} />
<VirtualScroller items={items} itemSize={50} itemTemplate={itemTemplate} className="border border-surface rounded-border" style={{ width: '200px', height: '200px' }} delay={150} />
<VirtualScroller items={items} itemSize={50} itemTemplate={itemTemplate} className="border border-surface rounded-border" style={{ width: '200px', height: '200px' }} delay={500} />
        `,
        javascript: `
