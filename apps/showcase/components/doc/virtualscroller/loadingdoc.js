...
export function LoadingDoc(props) {
    ...
    const code = {
        basic: `
<VirtualScroller items={items} itemSize={50} itemTemplate={itemTemplate} showLoader delay={250} className="border border-surface rounded-border" style={{ width: '200px', height: '200px' }} />
<VirtualScroller items={items} itemSize={50} itemTemplate={itemTemplate} showLoader delay={250} loadingTemplate={loadingTemplate} className="border border-surface rounded-border" style={{ width: '200px', height: '200px' }} />
        `,
        javascript: `
