    ...
    return (
        <div className="card flex flex-wrap gap-4">
            <div className="flex-1 flex flex-col items-center">
                ...
                <ColorPicker inputId="cp-hex" format="hex" value={colorHEX} onChange={(e) => setColorHEX(e.value)} className="mb-4" />
                <span>{colorHEX}</span>
            </div>
            <div className="flex-1 flex flex-col items-center">
                ...
                <ColorPicker inputId="cp-rgb" format="rgb" value={colorRGB} onChange={(e) => setColorRGB(e.value)} className="mb-4" />
            ...
            <div className="flex-1 flex flex-col items-center">
                ...
                <ColorPicker inputId="cp-hsb" format="hsb" value={colorHSB} onChange={(e) => setColorHSB(e.value)} className="mb-4" />
    ...
    return (
        <div className="card flex flex-wrap gap-4">
            <div className="flex-1 flex flex-col items-center">
                ...
                <ColorPicker inputId="cp-hex" format="hex" value={colorHEX} onChange={(e: ColorPickerChangeEvent) => setColorHEX(e.value)} className="mb-4" />
                <span>{colorHEX}</span>
            </div>
            <div className="flex-1 flex flex-col items-center">
                <label htmlFor="cp-rgb" className="font-bold block mb-2">
                ...
                <ColorPicker inputId="cp-rgb" format="rgb" value={colorRGB} onChange={(e: ColorPickerChangeEvent) => setColorRGB(e.value)} className="mb-4" />
                <span>{JSON.stringify(colorRGB)}</span>
            </div>
            <div className="flex-1 flex flex-col items-center">
                <label htmlFor="cp-hsb" className="font-bold block mb-2">
                ...
                <ColorPicker inputId="cp-hsb" format="hsb" value={colorHSB} onChange={(e: ColorPickerChangeEvent) => setColorHSB(e.value)} className="mb-4" />
                <span>{JSON.stringify(colorHSB)}</span>
            </div>
        </div>
    )
