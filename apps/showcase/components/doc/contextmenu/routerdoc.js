...
export function RouterDoc(props) {
    ...
    const code = {
        basic: `
<span className="inline-flex items-center justify-center border-2 border-primary rounded-border w-16 h-16" onContextMenu={(event) => onRightClick(event)} aria-haspopup="true">
