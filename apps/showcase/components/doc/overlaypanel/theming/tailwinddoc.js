    ...
    overlaypanel: {
        root: {
            className: classNames(
                'bg-white text-gray-700 border-surface-0 dark:border-surface-900 rounded-md shadow-lg',
                'z-40 transform origin-center',
                'absolute left-0 top-0 mt-4',
        ...
        closeButton: 'flex items-center justify-center overflow-hidden absolute top-0 right-0 w-6/12 h-6',
        content: 'p-8 items-center flex',
