    ...
    slider: {
        root: ({ props }) => ({
            className: classNames(
                'relative',
                'bg-gray-100 dark:bg-gray-800 border-surface-0 dark:border-surface-900 rounded-6',
                { 'h-1 w-56': props.orientation == 'horizontal', 'w-1/12 h-56': props.orientation == 'vertical' },
        ...
        handle: ({ props }) => ({
            className: classNames(
                'h-4 w-4/12 bg-white dark:bg-gray-600 border-2 border-blue-500 rounded-full transition duration-200',
