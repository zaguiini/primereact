...
export default function VerticalDemo() {
    ...
    return (
        <div className="card flex justify-center">
            <Slider value={value} onChange={(e) => setValue(e.value)} orientation="vertical" className="h-56" />
        </div>
    )
}
        `,
...
export default function VerticalDemo() {
    ...
    return (
        <div className="card flex justify-center">
            <Slider value={value} onChange={(e: SliderChangeEvent) => setValue(e.value)} orientation="vertical" className="h-56" />
        </div>
    )
}
        `
