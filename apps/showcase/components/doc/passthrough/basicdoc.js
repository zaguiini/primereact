    ...
    pt={{
        header: ({ state }) => ({
            ...
            className: classNames('border-primary', {
                'bg-primary text-primary-contrast': state.collapsed,
                'text-primary bg-primary-contrast': !state.collapsed
            })
        }),
        content: { className: 'border-primary text-lg text-primary-700' },
        title: 'text-xl', // OR { className: 'text-xl' }
        toggler: 'bg-primary text-primary-contrast hover:text-primary hover:bg-primary-contrast' // OR { className: 'bg-primary text-primary-contrast hover:text-primary hover:bg-primary-contrast' }
    }}
>
    <p className="m-0">
