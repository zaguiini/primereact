...
export function ProductsDoc(props) {
    ...
    const imageBodyTemplate = (rowData) => {
        return <img src={`https://primefaces.org/cdn/primereact/images/product/${rowData.image}`} alt={rowData.image} className="shadow rounded-border" style={{ width: '64px' }} />;
    };
    ...
    const code = {
        basic: `
<Toolbar className="mb-6" left={leftToolbarTemplate} right={rightToolbarTemplate}></Toolbar>
    ...
    return (
        <div>
            ...
            <Dialog visible={productDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                {product.image && <img src={\`https://primefaces.org/cdn/primereact/images/product/\${product.image}\`} alt={product.image} className="product-image block m-auto pb-4" />}
                <div className="field">
                ...
                <div className="field">
                    <label className="mb-4 font-bold">Category</label>
                    <div className="formgrid grid grid-cols-12 gap-4">
                        <div className="field-radiobutton col-span-6">
            ...
            <Dialog visible={deleteProductDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                <div className="confirmation-content">
                    <i className="pi pi-exclamation-triangle mr-4" style={{ fontSize: '2rem' }} />
                    {product && (
                        <span>
    ...
    return (
        <>
            ...
            <DeferredDemo onLoad={loadDemoData}>
                <div className="card">
                    <Toolbar className="mb-6" left={leftToolbarTemplate} right={rightToolbarTemplate} />
