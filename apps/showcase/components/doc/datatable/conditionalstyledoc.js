...
export function ConditionalStyleDoc(props) {
    ...
    const rowClass = (data) => {
        return {
            'bg-primary text-primary-contrast': data.category === 'Fitness'
        };
    };

    const stockBodyTemplate = (rowData) => {
        const stockClassName = classNames('rounded-full w-8 h-8 inline-flex font-bold justify-center items-center text-sm', {
