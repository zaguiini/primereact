...
export function TemplateDoc(props) {
    ...
    const imageBodyTemplate = (product) => {
        return <img src={`https://primefaces.org/cdn/primereact/images/product/${product.image}`} alt={product.image} className="w-24 shadow rounded-border" />;
    };
    ...
    const header = (
        <div className="flex flex-wrap items-center justify-between gap-2">
            <span className="text-xl text-surface-900 dark:text-surface-0 font-bold">Products</span>
