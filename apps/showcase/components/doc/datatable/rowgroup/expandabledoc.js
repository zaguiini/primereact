...
export function ExpandableRowGroupDoc(props) {
    ...
    const headerTemplate = (data) => {
        return (
            <React.Fragment>
                ...
                <span className="align-middle ml-2 font-bold leading-normal">{data.representative.name}</span>
            </React.Fragment>
        );
    };
    ...
    const footerTemplate = (data) => {
        return (
            <React.Fragment>
                <td colSpan={5}>
                    <div className="flex justify-end font-bold w-full">Total Customers: {calculateCustomerTotal(data.representative.name)}</div>
                </td>
            </React.Fragment>
        );
    };
            ...
            <DeferredDemo onLoad={loadDemoData}>
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="country" header="Country" body={countryBodyTemplate} style={{ width: '20%' }} />
