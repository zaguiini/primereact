...
const Tailwind = {
    calendar: {
        ...
        input: ({ props }) => ({
            root: {
                className: classNames('font-sans text-base text-gray-600 dark:text-white/80 bg-white dark:bg-gray-900 p-4 border border-gray-300 dark:border-blue-900/40 transition-colors duration-200 appearance-none', 'hover:border-blue-500', {
        ...
        panel: ({ props }) => ({
            className: classNames('bg-white dark:bg-gray-900', 'min-w-full', {
                'shadow-md border-surface-0 dark:border-surface-900 absolute': !props.inline,
        ...
        previousButton: {
            className: classNames(
                ...
                'w-8/12 h-8 text-gray-600 dark:text-white/70 border-surface-0 dark:border-surface-900 bg-transparent rounded-full transition-colors duration-200 ease-in-out',
        ...
        dayLabel: ({ context }) => ({
            className: classNames(
                'w-10/12 h-10 rounded-full transition-shadow duration-200 border-transparent border',
