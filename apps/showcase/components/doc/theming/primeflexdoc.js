...
<div className="flex flex-col md:flex-row justify-between my-8">
    <Button type="button" label="Button 1" className="mb-4 md:mb-0"></Button>
    <Button type="button" label="Button 2" className="p-button-secondary mb-4 md:mb-0"></Button>
    ...
    return (
        <>
            ...
            <div className="card flex flex-col md:flex-row justify-between my-8">
                <Button type="button" label="Button 1" className="mb-4 md:mb-0" />
                <Button type="button" label="Button 2" className="p-button-secondary mb-4 md:mb-0" />
