        ...
        <>
            <DocSectionText {...props}>
                <p>
                    ...
                    <span className="rounded-border inline-flex border w-8 h-8 p-0 items-center justify-center bg-primary text-primary-contrast">
                        <span className="pi pi-cog" />
                    </span>{' '}
                    at the topbar to switch themes.
                </p>
            </DocSectionText>
            <DocSectionCode code={code} hideToggleCode import hideStackBlitz codeClassName="h-80 overflow-auto" />
        </>
    );
}
