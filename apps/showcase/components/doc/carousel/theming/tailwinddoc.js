...
const Tailwind = {
    carousel: {
        ...
        previousbutton: {
            className: classNames('flex justify-center items-center self-center overflow-hidden relative shrink-0 grow-0', 'w-8/12 h-8 text-gray-600 border-surface-0 dark:border-surface-900 bg-transparent rounded-full transition duration-200 ease-in-out mx-2')
        },
        ...
        indicatorbutton: ({ context }) => ({
            className: classNames('w-8/12 h-2 transition duration-200 rounded-0', 'focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]', {
...
export default function UnstyledDemo() {
    ...
    const productTemplate = (product) => {
        return (
            <div className="border bg-white dark:bg-gray-900 border-gray-300 dark:border-blue-900/40 rounded-lg m-2 text-center py-8 px-4">
                ...
                <div>
                    ...
                    <h6 className="mt-0 mb-4 font-medium text-gray-700 dark:text-white/80">\${product.price}</h6>
                    <Tag value={product.inventoryStatus} severity={getSeverity(product)}></Tag>
                    <div className="mt-8 flex flex-wrap gap-2 justify-center align-center">
