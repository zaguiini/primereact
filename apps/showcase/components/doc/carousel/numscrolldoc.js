...
export function NumScrollDoc(props) {
    ...
    const productTemplate = (product) => {
        return (
            <div className="border border-surface rounded-border m-2 text-center py-8 px-4">
                <div className="mb-4">
                    <img src={`https://primefaces.org/cdn/primereact/images/product/${product.image}`} alt={product.name} className="w-6/12 shadow" />
                </div>
                <div>
                    <h4 className="mb-1">{product.name}</h4>
                    <h6 className="mt-0 mb-4">${product.price}</h6>
