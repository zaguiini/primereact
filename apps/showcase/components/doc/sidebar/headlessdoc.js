...
<Sidebar
    ...
    content={({ closeIconRef, hide }) => (
        <div className="min-h-screen flex relative lg:static bg-surface-50 dark:bg-surface-950">
            <div id="app-sidebar-2" className="bg-surface-0 dark:bg-surface-950 h-screen block shrink-0 absolute lg:static left-0 top-0 z-10 border-r border-surface select-none" style={{ width: '280px' }}>
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-6 pt-4 shrink-0">
                        ...
                        <span>
                            <Button type="button" ref={closeIconRef} onClick={(e) => hide(e)} icon="pi pi-times" rounded outlined className="h-8 w-8"></Button>
                        </span>
                    </div>
                    <div className="overflow-y-auto">
                        <ul className="list-none p-4 m-0">
                            <li>
                                <StyleClass nodeRef={btnRef1} selector="@next" enterClassName="hidden" enterActiveClassName="animate-slidedown" leaveToClassName="hidden" leaveActiveClassName="animate-slideup">
                                    <div ref={btnRef1} className="p-ripple p-4 flex items-center justify-between text-surface-600 dark:text-surface-200 cursor-pointer">
                                ...
                                <ul className="list-none p-0 m-0 overflow-hidden">
                                    <li>
                                        <a className="p-ripple flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors w-full">
                                    ...
                                    <li>
                                        <StyleClass nodeRef={btnRef2} selector="@next" enterClassName="hidden" enterActiveClassName="animate-slidedown" leaveToClassName="hidden" leaveActiveClassName="animate-slideup">
                                            <a ref={btnRef2} className="p-ripple flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors w-full">
                                        ...
                                        <ul className="list-none py-0 pl-4 pr-0 m-0 hidden overflow-y-hidden transition-all duration-[400ms] ease-in-out">
                                            <li>
                                                <StyleClass nodeRef={btnRef3} selector="@next" enterClassName="hidden" enterActiveClassName="animate-slidedown" leaveToClassName="hidden" leaveActiveClassName="animate-slideup">
                                                    <a ref={btnRef3} className="p-ripple flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors w-full">
                                                        <i className="pi pi-chart-line mr-2"></i>
                                    ...
                                    <li>
                                        <a className="p-ripple flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors w-full">
                                            ...
                                            <span className="inline-flex items-center justify-center ml-auto bg-blue-500 text-surface-0 dark:text-surface-900 rounded-full" style={{ minWidth: '1.5rem', height: '1.5rem' }}>
                                                3
                                            </span>
                                            <Ripple />
                                        </a>
                        ...
                        <ul className="list-none p-4 m-0">
                            <li>
                                <StyleClass nodeRef={btnRef4} selector="@next" enterClassName="hidden" enterActiveClassName="animate-slidedown" leaveToClassName="hidden" leaveActiveClassName="animate-slideup">
                                    <div ref={btnRef4} className="p-ripple p-4 flex items-center justify-between text-surface-600 dark:text-surface-200 cursor-pointer">
                    ...
                    <div className="mt-auto">
                        <hr className="mb-4 mx-4 border-t border-0 border-surface" />
                        <a v-ripple className="m-4 flex items-center cursor-pointer p-4 gap-2 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors p-ripple">
                            ...
                            <div id="app-sidebar-2" className="bg-surface-0 dark:bg-surface-950 h-screen block shrink-0 absolute lg:static left-0 top-0 z-10 border-r border-surface select-none" style={{ width: '280px' }}>
                                <div className="flex flex-col h-full">
                                    <div className="flex items-center justify-between px-6 pt-4 shrink-0">
                                        ...
                                        <span>
                                            <Button type="button" ref={closeIconRef} onClick={(e) => hide(e)} icon="pi pi-times" rounded outlined className="h-8 w-8" />
                                        </span>
                                    </div>
                                    <div className="overflow-y-auto">
                                        <ul className="list-none p-4 m-0">
                                                ...
                                                <ul className="list-none p-0 m-0 overflow-hidden">
                                                    ...
                                                    <li>
                                                        <StyleClass nodeRef={btnRef2} selector="@next" enterClassName="hidden" enterActiveClassName="animate-slidedown" leaveToClassName="hidden" leaveActiveClassName="animate-slideup">
                                                            <a
                                                                ref={btnRef2}
                                                                className="p-ripple flex items-center cursor-pointer p-4 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors w-full"
                                                            >
                                    ...
                                    <div className="mt-auto">
                                        ...
                                        <a
                                            v-ripple
                                            className="m-4 flex items-center cursor-pointer p-4 gap-2 rounded-border text-surface-700 dark:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors p-ripple"
                                        >
                                            <Avatar image="https://primefaces.org/cdn/primereact/images/avatar/amyelsner.png" shape="circle" />
                                            <span className="font-bold">Amy Elsner</span>
                                        </a>
