    ...
    sidebar: {
        root: ({ props }) => ({
            className: classNames(
                ...
                'bg-white text-gray-700 border-surface-0 dark:border-surface-900 shadow-lg',
                {
        ...
        header: {
            className: classNames('flex items-center justify-end', 'p-8')
        },
        closeButton: {
            className: classNames(
        ...
        content: {
            className: classNames('p-8 pt-0 h-full w-full', 'grow overflow-y-auto')
        },
        mask: {
