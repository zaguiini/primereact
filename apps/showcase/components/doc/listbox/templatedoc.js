...
<ListBox value={selectedCountry} onChange={(e) => setSelectedCountry(e.value)} options={countries} optionLabel="name" 
    itemTemplate={countryTemplate} className="w-full md:w-56" listStyle={{ maxHeight: '250px' }} />
        `,
        javascript: `
...
export default function TemplateDemo() {
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <ListBox value={selectedCountry} onChange={(e) => setSelectedCountry(e.value)} options={countries} optionLabel="name" itemTemplate={countryTemplate} className="w-full md:w-56" listStyle={{ maxHeight: '250px' }} />
            </div>
