...
export default function InvalidDemo() {
    ...
    return (
        <div className="card flex justify-center">  
            <ListBox invalid value={selectedCity} onChange={(e: ListBoxChangeEvent) => setSelectedCity(e.value)} 
                options={cities} optionLabel="name"  className="w-full md:w-56" />
        </div>
    )
}
        `
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <ListBox invalid value={selectedCity} onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name" className="w-full md:w-56" />
            </div>
