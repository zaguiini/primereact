...
export default function MultipleDemo() {
    ...
    return (
        <div className="card flex justify-center">  
            <ListBox multiple value={selectedCities} onChange={(e: ListBoxChangeEvent) => setSelectedCities(e.value)} options={cities} optionLabel="name" className="w-full md:w-56" />
        </div>
    )
}
        `
