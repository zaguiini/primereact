...
<ListBox value={selectedItem} onChange={(e) => setSelectedItem(e.value)} options={items} 
    virtualScrollerOptions={{ itemSize: 38 }} className="w-full md:w-56" listStyle={{ height: '250px' }} />
        `,
        javascript: `
...
export default function VirtualScrollDemo() {
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <ListBox value={selectedItem} onChange={(e) => setSelectedItem(e.value)} options={items} virtualScrollerOptions={{ itemSize: 38 }} className="w-full md:w-56" listStyle={{ height: '250px' }} />
            </div>
