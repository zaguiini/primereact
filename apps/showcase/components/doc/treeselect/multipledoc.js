...
<TreeSelect value={selectedNodeKeys} onChange={(e) => setSelectedNodeKeys(e.value)} options={nodes} metaKeySelection={false}  
    className="md:w-80 w-full" selectionMode="multiple" placeholder="Select Items"></TreeSelect>
        `,
        javascript: `
    ...
    return (
        <div className="card flex justify-center">
            <TreeSelect value={selectedNodeKeys} onChange={(e) => setSelectedNodeKeys(e.value)} options={nodes} 
                metaKeySelection={false} className="md:w-80 w-full" selectionMode="multiple" placeholder="Select Items"></TreeSelect>
        </div>    
    );
}
        `,
...
`
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <TreeSelect value={selectedNodeKeys} onChange={(e) => setSelectedNodeKeys(e.value)} options={nodes} metaKeySelection={false} className="md:w-80 w-full" selectionMode="multiple" placeholder="Select Items" />
            </div>
