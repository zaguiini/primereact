...
export default function BasicDemo() {
    ...
    return (
        <div className="card flex justify-center">
            <TreeSelect value={selectedNodeKey} onChange={(e) => setSelectedNodeKey(e.value)} options={nodes} 
                className="md:w-80 w-full" placeholder="Select Item" showClear></TreeSelect>
        </div>
    );
}
        `,
...
`
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <TreeSelect value={selectedNodeKey} onChange={(e) => setSelectedNodeKey(e.value)} options={nodes} className="md:w-80 w-full" placeholder="Select Item" showClear />
            </div>
