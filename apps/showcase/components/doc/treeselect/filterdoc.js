...
<TreeSelect value={selectedNodeKey} onChange={(e) => setSelectedNodeKey(e.value)} options={nodes} 
    filter className="md:w-80 w-full" placeholder="Select Item"></TreeSelect>
        `,
        javascript: `
...
`
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <TreeSelect value={selectedNodeKey} onChange={(e) => setSelectedNodeKey(e.value)} options={nodes} filter className="md:w-80 w-full" placeholder="Select Item" />
            </div>
