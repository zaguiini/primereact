    ...
    return (
        <>
            <DocSectionText {...props}>
                <p>
                    Mention is used as a controlled component with <i>value</i> and <i>onChange</i> properties. In addition, <i>suggestions</i> and a <i>onSearch</i> are required to query the results.
                </p>
            </DocSectionText>
            <div className="card flex justify-center">
                <Mention value={value} onChange={(e) => setValue(e.target.value)} suggestions={suggestions} onSearch={onSearch} field="nickname" placeholder="Enter @ to mention people" rows={5} cols={40} itemTemplate={itemTemplate} />
            </div>
