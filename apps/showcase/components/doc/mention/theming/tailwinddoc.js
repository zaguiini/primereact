...
const Tailwind = {
    mention: {
        root: 'relative',
        panel: 'max-h-[200px] overflow-auto bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 border-surface-0 dark:border-surface-900 rounded-md shadow-lg',
        items: 'py-4 list-none m-0',
        item: 'cursor-pointer font-normal overflow-hidden relative whitespace-nowrap m-0 p-4 border-surface-0 dark:border-surface-900 transition-shadow duration-200 rounded-none dark:text-white/80 dark:hover:bg-gray-800 hover:text-gray-700 hover:bg-gray-200',
