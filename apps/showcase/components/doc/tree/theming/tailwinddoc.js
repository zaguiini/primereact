...
const Tailwind = {
    tree: {
        root: {
            className: classNames('max-w-[30rem] md:w-full', 'border border-solid border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 p-8 rounded-md')
        },
        ...
        toggler: ({ context }) => ({
            className: classNames(
                ...
                'mr-2 w-8/12 h-8 border-surface-0 dark:border-surface-900 bg-transparent rounded-full transition duration-200',
        ...
        checkbox: ({ context, props }) => ({
            className: classNames(
                ...
                'border-2 w-6/12 h-6 rounded-lg transition-colors duration-200 text-white text-base dark:text-gray-900',
                {
        ...
        subgroup: {
            className: classNames('m-0 list-none', 'p-0 pl-6')
        },
        filtercontainer: {
        ...
        input: {
            className: classNames(
                'm-0 p-4 text-base w-full pr-16',
