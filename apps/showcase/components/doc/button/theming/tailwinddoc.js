    ...
    button: {
        root: ({ props, context }) => ({
            className: classNames(
                ...
                { 'px-6 py-4 text-base': props.size === null, 'text-xs py-2 px-4': props.size === 'small', 'text-xl py-4 px-6': props.size === 'large' },
        ...
        badge: ({ props }) => ({
            className: classNames({ 'ml-2 w-4/12 h-4 leading-none flex items-center justify-center': props.badge })
        })
    }
}
        `
