...
export default function FilledDemo() {
    ...
    return (
        <>
            ...
            <div className="card flex justify-center">
                <Dropdown variant="filled" value={selectedCity} onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name" placeholder="Select a City" className="w-full md:w-56" />
            </div>
