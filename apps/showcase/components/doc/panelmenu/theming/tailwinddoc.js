...
const Tailwind = {
    panelmenu: {
        ...
        headeraction: {
            className: classNames('flex items-center select-none cursor-pointer relative no-underline', 'text-gray-700 dark:text-white/80 p-8 font-bold')
        },
        submenuicon: 'mr-2',
        headericon: 'mr-2',
        ...
        menu: {
            className: classNames('outline-0', 'm-0 p-0 list-none')
        },
        menuitem: ({ context }) => ({
            className: classNames(
                'text-gray-700 dark:text-white/80 transition-shadow duration-200 border-0 rounded-none',
        ...
        action: {
            className: classNames('text-gray-700 dark:text-white/80 py-4 px-8 select-none', 'flex items-center cursor-pointer no-underline relative overflow-hidden')
        },
        icon: 'mr-2',
        submenu: 'p-0 pl-6 m-0 list-none',
