...
const Tailwind = {
    terminal: {
        root: {
            className: classNames('border border-gray-300 p-8', 'bg-gray-900 text-white dark:border-blue-900/40 ', 'h-72 overflow-auto')
        },
        container: 'flex items-center',
        prompt: 'text-yellow-400',
        commandtext: 'flex-1 shrink grow-0 border-surface-0 dark:border-surface-900 bg-transparent text-inherit p-0 outline-0'
    }
}
    `
    };
