...
export function ColorsDoc(props) {
    return (
        <>
            ...
            <div className="flex">
                <div className="h-32 w-32 flex justify-center items-center mr-8 font-bold bg-blue-600" style={{ borderRadius: '10px' }}>
                    <span className="text-white">GOOD</span>
                </div>
                <div className="h-32 w-32 flex justify-center items-center mr-8 font-bold bg-blue-400" style={{ borderRadius: '10px' }}>
            ...
            <div className="flex">
                <div className="h-32 w-32 flex justify-center items-center mr-8 font-bold bg-pink-500" style={{ borderRadius: '10px' }}>
            ...
            <div className="flex">
                <div className="h-32 w-32 flex flex-col justify-center items-center mr-8 font-bold bg-gray-900" style={{ borderRadius: '10px' }}>
