...
const Tailwind = {    
    picklist: {
        ...
        controls: 'flex flex-row xl:flex-col justify-center p-8',
        moveUpButton: {
            root: {
                className: classNames(
                    ...
                    'justify-center px-0 py-4', // icon only
        ...
        header: {
            className: classNames(
                'bg-slate-50 text-slate-700 border border-gray-300 p-8 font-bold border-b-0 rounded-t-md',
        ...
        list: {
            className: classNames(
                ...
                'border border-gray-300 bg-white text-gray-600 py-4 px-0 rounded-b-md outline-0',
                'dark:border-blue-900/40 dark:bg-gray-900 dark:text-white/80' //Dark Mode
            )
        },
        item: ({ context }) => ({
            className: classNames('relative cursor-pointer overflow-hidden', 'py-4 px-8 m-0 border-0 text-gray-600 dark:text-white/80', 'transition duration-200', {
                'text-blue-700 bg-blue-500/20 dark:bg-blue-300/20': context.selected,
                'text-gray-600 dark:bg-blue-900/40': !context.selected
            })
        }),
        buttons: 'flex flex-row xl:flex-col justify-center p-8',
        movetotargetbutton: {
            root: {
                className: classNames(
                    'relative inline-flex cursor-pointer user-select-none items-center align-bottom text-center overflow-hidden m-0', // button component
        ...
        targetcontrols: 'flex flex-col justify-center p-8',
