...
export function TemplateDoc(props) {
    const tab1HeaderTemplate = (options) => {
        return (
            <div className="flex items-center gap-2 p-4" style={{ cursor: 'pointer' }} onClick={options.onClick}>
...
<TabView>
    ...
    <TabPanel headerTemplate={tab2HeaderTemplate} headerClassName="flex items-center">
        <p className="m-0">
    ...
    <TabPanel headerTemplate={tab3HeaderTemplate} headerClassName="flex items-center">
        <p className="m-0">
