        ...
        accordiontab: {
            ...
            headerAction: ({ context }) => ({
                className: classNames(
                    ...
                    'p-8 transition duration-200 ease-in-out rounded-t-md font-bold transition-shadow duration-200', // Padding and transition
            ...
            content: {
                className: classNames(
                    'p-8 border border-gray-300 bg-white text-gray-700 border-t-0 rounded-tl-none rounded-tr-none rounded-br-lg rounded-bl-lg',
