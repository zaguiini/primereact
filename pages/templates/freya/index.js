...
const animationFeaturesData1 = [
    ...
    },
    {
        id: 4,
        title: "Figma File",
        description: "Freya uses Figma as the design tool. It will be possible to download the Figma file after your purchase. You can preview the Figma file before the purchase. Note that PrimeVue UI components are excluded from the Freya Figma file as they are available in PrimeOne for Figma only.",
...
const FreyaPage = () => {
    ...
    return (
        <div className='freya template'>
            ...
            <FreyaSeparator />
            <TemplateFeaturesAnimation featuresData={animationFeaturesData2} title={["Features that the","Freya template gives you"]}/>
            <FreyaSeparator />
            <TemplateConfiguration title='Vue.js App with No Configuration' description='Freya is powered by Angular CLI to get started in no time following the best practices like service based component interaction modular design and strict mode support' />
            <FreyaSeparator />
