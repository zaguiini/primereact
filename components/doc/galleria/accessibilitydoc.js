    ...
    return (
        <DocSectionText id="accessibility" label="Accessibility">
            ...
            <p>
                ...
                API. Similarly <i>aria.slide</i> is used as the <i>aria-roledescription</i> of the item. Inactive slides are hidden from the readers with <i>aria-hidden</i>.
            </p>

            <p>
                Next and Previous navigators are button elements with <i>aria-label</i> attributes referring to the <i>aria.nextPageLabel</i> and <i>aria.firstPageLabel</i> properties of the{' '}
                <Link legacyBehavior href="/locale">
                    locale
                </Link>{' '}
                API by default respectively, you may still use your own aria roles and attributes as any valid attribute is passed to the button elements implicitly by using <i>nextButtonProps</i> and <i>prevButtonProps</i>.
            </p>
            ...
            <p>
                ...
                API. Current page is marked with <i>aria-current</i>.
            </p>
