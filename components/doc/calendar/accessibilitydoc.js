    ...
    return (
        <DocSectionText id="accessibility" label="Accessibility">
            ...
            <p>
                ...
                API. This label is also used for the <i>aria-label</i> of the popup as well. When there is a value selected, it is formatted and appended to the label to be able to notify users about the current value.
            </p>
            ...
            <p>
                Timepicker spinner buttons get their labels for <i>aria-label</i> from the aria locale API using the <i>prevHour</i>, <i>nextHour</i>, <i>prevMinute</i>, <i>nextMinute</i>, <i>prevSecond</i>, <i>nextSecond</i>, <i>am</i> and <i>pm</i>{' '}
                keys.
            </p>
