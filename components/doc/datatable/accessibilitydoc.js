    ...
    return (
        <DocSectionText id="accessibility" label="Accessibility">
            ...
            <p>
                ...
                <i>aria.selectRow</i> and <i>aria.unselectRow</i> properties of the{' '}
                <Link legacyBehavior href="/locale">
                    locale
                </Link>{' '}
                API. Similarly header checkbox uses <i>selectAll</i> and <i>unselectAll</i> keys. When a row is selected, <i>aria-selected</i> is set to true on a row.
            </p>
            ...
            <p>
                ...
                the button and the overlay. Popop menu has <i>dialog</i> role with <i>aria-modal</i>
                as focus is kept within the overlay. The operator dropdown use <i>aria.filterOperator</i> and filter constraints dropdown use <i>aria.filterConstraint</i> properties. Buttons to add rules on the other hand utilize <i>aria.addRule</i>{' '}
                and <i>aria.removeRule</i> properties. The footer buttons similarly use
                <i>aria.clear</i> and <i>aria.apply</i> properties. <i>filterInputProps</i> of the Column component can be used to define aria labels for the built-in filter components, if a custom component is used with templating you also may
                define your own aria labels as well.
            </p>
            ...
            <h4>Sortable Headers Keyboard Support</h4>
            <p>
